...
static void test_leaf_slot_alloc(void)
{
    ...
    uint8_t val3[] = "grape";
    uint8_t buf3[64];
    leaf_rec_pack(buf3, key3, 5, val3, 5, true);
...
static void test_slot_remove_and_compact(void)
{
    ...
    page_remove_slot(&pg, 0);
    page_remove_slot(&pg, 2);
